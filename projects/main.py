...
BG_MUSIC = pygame.mixer.Sound("assets/sounds/bg.mp3")
    ...
    while running:
        ...
        if displayed_planet:
            if displayed_planet.name != "Sun":
                ...
                for i, line in enumerate(planet_info_lines):
                    planet_info_text_2 = FONT.render(line, True, (255, 255, 255))
                    win.blit(planet_info_text_2, (50, start_y + i * 30))
                ...
                path = f"assets/images/symbols/{displayed_planet.name.lower()}.jpg"
                win.blit(pygame.image.load(path), (85, planet_info_text_2.get_height() + 20))
            ...
            # Info text for Sun
                ...
                # List of lines for sun information
                sun_info_lines = [
                    f"Mass: {sun.mass} kg",
                ...
                start_y = 100  # Adjust as needed for your display
                win.blit(sun_info_text_1, (10, 20))
                # Render and blit each line separately
                for i, line in enumerate(sun_info_lines):
                    sun_info_text_2 = FONT.render(line, True, (255, 255, 255))
                    win.blit(sun_info_text_2, (50, start_y + i * 30))  # Adjust x/y positions as needed

                # Blit the source text
                source_text = FONT.render("Source: NASA", True, (255, 255, 255))
